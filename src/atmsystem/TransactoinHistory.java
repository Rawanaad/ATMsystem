 ...
 * @author Rawan
 */
public class TransactoinHistory implements ATMI {
    // database
    public static ArrayList<Account> users = new ArrayList<Account>();
    public static ArrayList<Admin> admins = new ArrayList<Admin>();

    @Override
    public Account getCustomerInfo(int accountNumber) {
        for (Account A : users){
    ...
    @Override
    public boolean creatNewCustomer(Account customer) {
        if (customer != null){
            users.add(customer);
            return true ;  
        }
    ...
    public Admin getAdminInfo(int accountNumber) {
        for (Admin A : admins){
            if (A.getAccountNumber() == accountNumber){
                return A ; 
            }
    ...
    public void adminMenu(int index){
        ...
        switch(ch){
            case 1:{
               Account temp= admins.get(index).creatNewAccount();
            ...
            case 2:{
                   Admin temp= admins.get(index).creatNewAdmin();
    ...
    public boolean transferMoney(Account sender , Account reciever ,int cash){
